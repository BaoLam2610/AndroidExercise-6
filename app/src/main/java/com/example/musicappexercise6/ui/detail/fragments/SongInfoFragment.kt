...
class SongInfoFragment : Fragment(), MediaPlayer.OnCompletionListener {
    ...
    companion object {
        ...
        fun setSongUI() {
            ...
            binding.tvAlbum.text = "Album: ${song?.album}"
        }
    }
    ...
    fun createMusicPlayer() {
        try {
            ...
            MusicPlayerActivity.binding.seekBar.max =
    ...
    override fun onCompletion(mp: MediaPlayer?) {
        if (SongPresenter.isRepeatAll) {
            ...
            try {
                ...
                NowPlayingFragment.binding.tvTitle.text =
                    ChartFragment.mSongList[MusicPlayerActivity.position].name
                NowPlayingFragment.binding.tvArtist.text =
                    ChartFragment.mSongList[MusicPlayerActivity.position].artists_names
